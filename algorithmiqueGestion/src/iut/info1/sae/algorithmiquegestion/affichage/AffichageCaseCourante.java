...
public class AffichageCaseCourante {
	...
	private static int nombreColonnes = MenuLabyrinthe.getLabyrinthe()
	                                    .getNombreDeColonne();
    ...
    /**
     * Vérification de la possibilité d'afficher un mur horizontal en fonction
     * des liaisons du sommet dont l'indice de position est en paramètre et le
     * sommet adjacent dont l'indice est aussi en paramètre.
     *
     * @param indicePositionActuelle Indice du sommet où se trouve le joueur.
     * @param indiceSommetAdjacent Indice du sommet adjacent auquel vérifier la liaison.
     * @return true si il faut afficher un mur horizontal.
     */
    private static boolean affichageMursHorizontalement(int indicePositionActuelle,
                                                    int indiceSommetAdjacent) {
        return indicePositionActuelle < labyrinthe.getGraphe().getNombreSommets() - 1
            ...
            && listeSommets[indicePositionActuelle]
               .liaisonExiste(listeSommets[indiceSommetAdjacent]);
    }
    
    /**
     * Vérification de la possibilité d'afficher un mur vertical en fonction
     * des liaisons du sommet dont l'indice de position est en paramètre et le
     * sommet adjacent dont l'indice est aussi en paramètre.
     *
     * @param indicePositionActuelle Indice du sommet où se trouve le joueur.
     ...
     */
    private static boolean affichageMursVerticalement(int indicePositionActuelle,
                                                 int indiceSommetAdjacent) {
