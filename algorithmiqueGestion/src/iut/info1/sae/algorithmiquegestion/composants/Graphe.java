...
public class Graphe {
    ...
    /**
     * Création d'un sommet rattaché à this en fonction de son indice dans la liste
     * des sommets.
     *
    ...
    public Sommet creerSommet(int indiceCourantListeSommet) {
        int coordonneeX, coordonneeY, indiceCaseCourante;

        coordonneeX = indiceCourantListeSommet % this.nombreColonnesLabyrinthe;
    ...
    /**
     * Vérifie si deux sommets sont adjacents à l'aide de leurs coordonnées.
     * 
    ...
    public boolean estAdjacent(int indiceSommet1, int indiceSommet2) {
        ...
        if (!this.sommetExiste(indiceSommet1) || !this.sommetExiste(indiceSommet2)) {
            return false;
        }
    ...
    /**
     * Permet de déterminer les sommets adjacents à un sommet dont l'indice dans la
     * liste des sommets de this est en paramètre.
     *
    ...
    public Sommet[] tousLesSommetsAdjacentsDuSommet(int indiceSommet) {
        ...
        int[] listeSommetAdjacentPossible = { indiceSommet + this.getNombreColonnesLabyrinthe(),
                indiceSommet - this.getNombreColonnesLabyrinthe(), indiceSommet + 1, indiceSommet - 1 };
    ...
    /**
     * Permet de vérifier l'existance d'un sommet dans this à partir de ses
     * coordonnées.
     * 
     * @param sommet
