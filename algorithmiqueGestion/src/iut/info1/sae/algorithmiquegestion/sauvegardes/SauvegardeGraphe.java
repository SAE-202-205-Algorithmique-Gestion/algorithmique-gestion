...
public class SauvegardeGraphe {
	...
	/**
	 * Chemin absolu vers le fichier de sauvegarde dédié 
	 * au graphe concerné par l'instance.
	 * 
	 ...
	 * @param graphe
	 */
	public SauvegardeGraphe(String cheminFichierSauvegarde, 
	 ...
	 * du graphe.
	 * 
	 * @return Le chemin absolu vers le fichier de 
	...
	/**
	 * Modifie le chemin vers le fichier de sauvegarde
	 * du graphe.
	 * 
	 * @param nouveauChemin Nouveau chemin qui remplacera 
	 * 						le courant
	 */
	 ...
	 * 
	 * @return Le nom choisi par l'utilisateur pour la 
	 * 		   sauvegarde courante
	 */
	 ...
	 * 
	 * @param nouveauNomSauvegarde Le nom choisi par
	 * 							   l'utilisateur pour la
	 * 							   sauvegarde courante
	 */
	...
	/**
	 * Retourne le graphe concerné par l'instance de 
	 * sauvegarde courante.
	 * 
	 * @return L'instance du graphe concerné par la 
	 * 		   sauvegarde courante
	 */
