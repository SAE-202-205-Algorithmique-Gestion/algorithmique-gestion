...
/**
 * Classe d'exception héritée de RuntimeException rapportant l'erreur d'une pile
 * vide.
 * 
...
public class PileVideException extends RuntimeException {
    ...
    /**
     * Construit une nouvelle exception d'exécution avec un message de détail passé
     * en paramètre.
     * 
