...
public class Pile {
    ...
    /**
     * Initialisation d'une pile vide et instanciation d'une liste d'objets de
     * taille CAPACITE_INITIALE.
     */
    public Pile() {
        super();
     ...
     * <p>
     * Commande modifiant l'état de this.
     * </p>
     * 
    ...
    /**
     * Retire de cette pile la référence du dernier élément empilé en suivant la
     * méthode LIFO (DAPS en français).
     * 
    ...
    /**
     * Reallocation d'un nouveau tableau lorsque le tableau elements est plein et
     * recopie des anciens éléments.
     */
    private void verifierTailleElements() {
        final double GROSSISSEMENT = 1.25; // 25% de taille
        if (taille == contenu.length) {
            contenu = Arrays.copyOf(contenu, (int) Math.ceil(taille * GROSSISSEMENT));
