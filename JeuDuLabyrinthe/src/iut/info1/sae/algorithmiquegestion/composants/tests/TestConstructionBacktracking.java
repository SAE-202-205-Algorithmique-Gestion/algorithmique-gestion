...
class TestConstructionBacktracking {
    ...
    void testSommetsAdjacentsNonParcourus() {
        ...
        Sommet[] sommetsAdjacents1 = { grapheTeste.getListeSommets()[12], grapheTeste.getListeSommets()[2],
        ...
        Sommet[] sommetsAdjacents3 = { grapheTeste.getListeSommets()[17], grapheTeste.getListeSommets()[23] };

        Sommet[] sommetsDejaParcourus = { grapheTeste.getListeSommets()[5], grapheTeste.getListeSommets()[8],
                grapheTeste.getListeSommets()[21] };

        for (int sommetsParcourus = 0; sommetsParcourus < sommetsDejaParcourus.length; sommetsParcourus++) {
    ...
    /**
     * Créé un graphe à partir de l'algorithme de backtracking puis affiche ses
     * liaisons dans la console texte afin de vérifier sa validité
     */
    @AfterAll
