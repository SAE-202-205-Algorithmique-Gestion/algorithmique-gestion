...
/**
 * Création d'un graphe en utilisant la méthode de création par chaînes
 * ascendantes.
 * 
...
public class ChainesAscendantes extends Graphe {
    ...
    /**
     * Création d'un graphe par chaînes ascendantes avec les nombres de colonnes et
     * de lignes du labyrinthe lié.
     *
