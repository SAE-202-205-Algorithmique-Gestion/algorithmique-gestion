...
/**
 * Affichage sur console texte d'un jeu de labyrinthe représenté sous forme de
 * Graphe avec un point de départ (l'entrée) E, un point de sortie S et une
 * position courante X.
 * 
            ...
            for (int i = 0; i < labyrinthe.getGraphe().getNombreSommets(); i++) {
                ...
                if (labyrinthe.getGraphe().getListeSommets()[i].getCoordonneeY() == ligne + 1) {
                    ...
                    for (int rang = 0; rang < labyrinthe.getGraphe().getNombreColonnesLabyrinthe(); rang++) {
                        if (labyrinthe.getGraphe().getListeSommets()[i + rang].liaisonExiste(labyrinthe.getGraphe()
                                .getListeSommets()[i + rang - labyrinthe.getGraphe().getNombreColonnesLabyrinthe()])) {
                ...
                if (i < labyrinthe.getGraphe().getNombreSommets() - 1) {
                    if (labyrinthe.getGraphe().getListeSommets()[i]
                            .getCoordonneeY() == labyrinthe.getGraphe().getListeSommets()[i + 1].getCoordonneeY()) {
                        if (labyrinthe.getGraphe().getListeSommets()[i]
                                .liaisonExiste(labyrinthe.getGraphe().getListeSommets()[i + 1])) {
